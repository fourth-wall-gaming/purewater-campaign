...
- [The Order of the Blue Star](factions/the-order-of-the-blue-star.md) — An institutional order of mages marked by a blue star at the brow. Trained Conall (through Old Johz) in arcane magic and investigation; takes a careful interest in dangerous power. The one faction a PC already belongs to.
