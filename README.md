...
|---|---|
| Lore entries | 15 |
| Characters | 36 (PCs: Conall Bjornlasch, Gardwen, Magda, Randall) |
...
- [Hollow man (the digger)](characters/npcs/hollow-man-the-digger.json) — One of two working the drowned street on Lost Isle. A boatman or a labourer once; something off the threshold is sitting in him now, and he likes the digging. What careless anchoring produces.
...
- [Mistress Corliss (the school)](characters/npcs/mistress-corliss-the-school.json) — Keeps the temple school at Corbie's on the Northern Isles: about sixty, forty girls in her charge, and a settled preference for a silly thing on a still day over anything exciting.
...
- [Santo di Teufel](characters/npcs/santo-di-teufel.json) — Baron Hanzo's cruel son and heir -- a sadistic young fire-mage who taught himself demonology by tracing his father's work and can open a channel but **cannot seat a binding**. His whole capability was one scroll stolen from his father's locked case; he spent it on Emmeralda and botched it. Carries a ritual knife marked with the sigil of Asmodeus, and four twists of hair he no longer has the means to use.
