---
id: "myth-lore-2d71b983fc0c"
title: "GM Guide: Supporting and Offscreen Cast"
category: "gm-guide"
visibility: "gm"
summary: "The named minor and offscreen figures the novelization references -- mentors, handlers, royals, and the dead -- so nobody important falls through the cracks."
created_at: "2026-06-25T10:48:16"
---

**GM reference.** Beyond the main cast (see `dramatis-personae`), the source names
a number of figures who shape the story from its edges. Those likely to appear in
Purewater have full sheets; the rest are recorded here.
...
- **Jubal** -- in the original Zorastor telling, the crime lord who raised Randall; his role is filled by [[Crowbill]] in Purewater. Use the name as an alias or a lieutenant if desired.
- **Saliman** -- a handler/fence in the criminal organization; a minor contact Randall and Nus can sell information to.